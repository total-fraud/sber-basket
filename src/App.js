...
import {toDeposit} from "./features/deposit/depositSlice";
...
function App() {
    ...
    const clientProductsDeposit = useAppSelector(state => state.clientBasket.items)
    ...
    return (<div className="App">
            ...
            <div className="checkoutBasket">
                <div>Статус покупки/продажи: {} {depositMoney}$</div>
